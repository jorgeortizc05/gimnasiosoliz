...
public class ProductoDAO {
    ...
    public boolean guardar(Producto producto){
        ...
        try {
            ...
            PreparedStatement st = connect.prepareStatement("insert into producto (nombre, descripcion, precio, codigo_barra, foto, subcategoria_id) values (?,?,?,?,?,?)");
            ...
            st.setInt(6, producto.getSubCategoriaId());
            st.execute();
    ...
    public Producto getProducto(int id){
        ...
        try {
            ...
            if(result.next()){
                ...
                item.setSubCategoriaId(result.getInt("subcategoria_id"));
    ...
    public boolean actualizar(Producto item){
        ...
        try {
            ...
            st.setInt(6, item.getSubCategoriaId());
    ...
    public List<Producto> getProductos(){
        ...
        try{
            ...
            while(result.next()){
                ...
                producto.setSubCategoriaId(result.getInt("subcategoria_id"));
                items.add(producto);
            }
            connect.close();
            return items;
