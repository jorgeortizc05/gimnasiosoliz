...
public class EmpresaView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPDatos.add(JPListaEmpresas, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 280, 1260, 480));

        jScrollPane5.setViewportView(jPDatos);

        add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1280, 768));
