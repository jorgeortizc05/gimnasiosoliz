 ...
 * @author jorge
 */
public class EditarPersonaViewJDialog extends javax.swing.JDialog {
    ...
    public EditarPersonaViewJDialog(java.awt.Frame parent, boolean modal, Persona persona) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1276, 410));
